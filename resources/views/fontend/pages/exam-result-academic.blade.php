                    ...
                    <div class="row latest-news blog-v1 student-panel">
                        <div class="panel panel-info routine-panel">
                            <div class="panel-heading">
                                <h3 class="class-routine-title">একাডেমিক পরীক্ষার ফলাফল</h3>
                            </div>
                            <br>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <div class="routine-btn">
                                            <button id="academic_result_search_button" type="button" class="p-color-bg themehover">View Result</button>
                                        </div>
                                    </div>
                                </div>
                            </form> <!-- /form -->
                        ...
                        <div id="academic_result_container" class="tab-rutne">
        ...
        $(document).ready(function () {
            ...
            $('#academic_result_search_button').click(function () {
                ...
                if(campus_id && institute_id && section && semester && gr_no){
                    // ajax request
                    $.ajax({
                        url: "{{URL::to('/academic/exam/result')}}",
                        type: 'POST',
                        cache: false,
