                ...
                <section class="panel">                
                    ...
                    <div class="panel-body">
                        <form role="form" action="{{url('/admin/public/result/store')}}" method="post">
                            ...
                            <div class="form-group">
                                <label>Percent %</label>
                                 <input type="text"  name="pass_presen" id="pass-presen" class="form-control" required="">
                                 <div class="help-block text-danger">
                                     @if ($errors->has('pass_year'))
                                        <strong>{{ $errors->first('pass_year') }}</strong>
                                     @endif
                            ...
                            <div class="form-group">
                              ...
                              <select class="form-control" name="exam_type" id="type">
                                <option disabled selected="">---Choices an option---</option>
