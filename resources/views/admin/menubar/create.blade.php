                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form action="{{URL::to('admin/menubar/store')}}"  enctype="multipart/form-data" method="post" role="form">
                             ...
                             <label for="exampleInputEmail1">Select Page:</label>
                               <select name="select_page_id" class="form-control m-bot15">
                                  ...
                                  @foreach($page_names as $page_name)
                                    <option value="{{$page_name->page_id}}">{{$page_name->page_name}}</option>
                                 @endforeach
                                  </select>
                            </div>
                           ...
                           <div class="form-group">
                             <label for="exampleInputEmail1">Select Page:</label>
                               <select name="menu_type" class="form-control m-bot15">
                                  <option value="0">Single Menu</option>
                                  <option value="1">Service Menu</option>
                                  <option value="2">Industry Menu</option>
                                  <option value="3">Product Menu</option>
                                  </select>
                            </div>
